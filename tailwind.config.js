...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'neon-mint':    '0 0 16px rgba(16,185,129,0.25), 0 0 4px rgba(16,185,129,0.4)',
        'neon-body':    '0 0 16px rgba(255,87,87,0.25),  0 0 4px rgba(255,87,87,0.3)',
        'neon-mind':    '0 0 16px rgba(139,92,246,0.25), 0 0 4px rgba(139,92,246,0.3)',
        'neon-growth':  '0 0 16px rgba(6,182,212,0.25),  0 0 4px rgba(6,182,212,0.3)',
        'neon-funplay': '0 0 16px rgba(249,115,22,0.25), 0 0 4px rgba(249,115,22,0.3)',
