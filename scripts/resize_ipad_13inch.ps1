...
$outAllDir = "C:\calamusAppBuild\MyReDesign_App\public\AppStore_Screenshots_iPad13inch_2048x2732_ALL"
$outTop10Dir = "C:\calamusAppBuild\MyReDesign_App\public\AppStore_Screenshots_iPad13inch_2048x2732_TOP10"
...
Write-Host "Success! 13-inch iPad (2048x2732) screenshots created."
